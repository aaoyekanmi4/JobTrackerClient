 ...
 const handleSubmitCredentials = (event) => {
  ...
  return (
    <form onSubmit={handleSubmitCredentials}>
      ...
      <input className="form-input" type="text" value={loginInput.user_name}id="username" name="user_name" onChange ={handleChange}/>

      <label className="form-label" htmlFor="password">password</label>
      <input className="form-input"  type="password" value={loginInput.password} id="password" name="password" onChange ={handleChange}/>
